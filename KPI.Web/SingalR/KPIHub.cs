...
namespace KPI.Web.SingalR
{
    ...
    public class KPIHub : Hub
    {
        ...
        public static void PushToAllUsers(AnnouncementViewModel message, KPIHub hub)
        {
        ...
        public static void PushToUser(string who, AnnouncementViewModel message, KPIHub hub)
        {
            IHubConnectionContext<dynamic> clients = GetClients(hub);
        ...
        /// <param name="who"></param>
        /// <param name="message"></param>
        public static void PushToUsers(string[] whos, AnnouncementViewModel message, KPIHub hub)
        {
            IHubConnectionContext<dynamic> clients = GetClients(hub);
        ...
        private static IHubConnectionContext<dynamic> GetClients(KPIHub teduShopHub)
        {
            if (teduShopHub == null)
                return GlobalHost.ConnectionManager.GetHubContext<KPIHub>().Clients;
            else
